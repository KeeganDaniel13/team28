...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView btnSignup = (TextView) findViewById(R.id.login);
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null) {
                try {
                    ...
                    {
                        Toast.makeText(Login.this, "Incorrect combination of Username or Password,Try Again",
                    ...
                    if(loginResult!=null)
                    {
                        ...
                        //snackbar.show();
                        Toast.makeText(Login.this, "Welcome, "+ username.getText().toString(),
                                Toast.LENGTH_LONG).show();
                    }
