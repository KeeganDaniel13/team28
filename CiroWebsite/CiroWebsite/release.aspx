<%@ Page Title="" Language="C#" MasterPageFile="~/ciro.Master" AutoEventWireup="true" CodeBehind="release.aspx.cs" Inherits="CiroWebsite.release" %>
   ...
   <div class="col-md-3 col-sm-6">
			...
			<div class="col-md-3 col-sm-6">
				<div class="widget">
					...
					<div class="widget-body text-center">
						...
						<h4 class="m-b-md">Jack Reacher</h4>
						<p class="text-muted m-b-lg">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Placeat officiis aperiam incidunt.</p>
						<a href="#" class="btn p-v-xl btn-info btn-xs btn-outline">View Request</a>
					</div><!-- .widget-body -->
				</div><!-- .widget -->
			...
			<div class="col-md-3 col-sm-6">
				<div class="widget">
					...
					<hr class="widget-separator">
					<div class="widget-body text-center">
						<div class="big-icon m-b-md watermark"><i class="fa fa-5x fa-drupal"></i></div>
						<h4 class="m-b-md">Johnny Drama</h4>
						<p class="text-muted m-b-lg">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Placeat officiis aperiam incidunt.</p>
						<a href="#" class="btn p-v-xl btn-info btn-xs btn-outline">View Request</a>
					</div><!-- .widget-body -->
				</div><!-- .widget -->
            ...
            <div class="col-md-3 col-sm-6">
				<div class="widget">
					...
					<div class="widget-body text-center">
						<div class="big-icon m-b-md watermark"><i class="fa fa-5x fa-drupal"></i></div>
						<h4 class="m-b-md">Eric Bellinger</h4>
						<p class="text-muted m-b-lg">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Placeat officiis aperiam incidunt.</p>
						<a href="#" class="btn p-v-xl btn-info btn-xs btn-outline">View Request</a>
					</div><!-- .widget-body -->
				</div><!-- .widget -->
