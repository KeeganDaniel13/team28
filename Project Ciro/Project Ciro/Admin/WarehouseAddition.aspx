<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="WarehouseAddition.aspx.cs" Inherits="Project_Ciro.Admin.WarehouseAddition" %>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <!--    <p>For alternative validation library <code>parsleyJS</code> check out in the <a href="form.html">form page</a> -->
                      ...
                      <span class="section">Warehouse Info</span>                     
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                           <button id="send" style="width:100%" type="submit" class="btn btn-success">Add Warehouse</button>
