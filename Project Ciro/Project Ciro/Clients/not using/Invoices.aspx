<%@ Page Title="" Language="C#" MasterPageFile="~/Clients/Client.Master" AutoEventWireup="true" CodeBehind="Invoices.aspx.cs" Inherits="Project_Ciro.Clients.Invoices" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
               ...
               <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><div contenteditable>Presto</div></td>
                    ...
                    <td><div contenteditable>Presto</div></td>
                    <td>                                                                  
                         <a href="#popup1" class="btn btn-social-icon btn-dropbox"><span title="Request Release"><i class="fa fa-dropbox"></i></span></a>
  ...
  <div id="popup1" class="overlay">
	<div class="popup">
		<h4 style="margin-left:33%; color:white">YOU CAN'T SEE ME!</h4><!---->
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i class="fa fa-globe"></i> Invoice <small>#232301</small>
