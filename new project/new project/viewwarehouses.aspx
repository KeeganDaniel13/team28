<%@ Page Title="" Language="C#" MasterPageFile="~/manager.Master" AutoEventWireup="true" CodeBehind="viewwarehouses.aspx.cs" Inherits="new_project.viewwarehouses" %>
        ...
        <div class="">
            <div class="page-title">
              ...
              <div class="title_left row">
                   <i class="fa fa-file-text fa-5x big-icon icon"></i>
               <h1 class=""><span class="middle">Warehouse Information </span></h1>
              </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Lanseria Aiport Warehouse</h2>
